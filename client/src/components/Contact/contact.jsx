...
const Contact = () => {
    ...
    return (
        <div className="w-screen pt-16 px-4  sm:px-6 lg:px-8 bg-gray-50 ">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600">+92 348 4538217</p>
                                    <p className="text-gray-600 mt-1">Mon-Fri, 9am-5pm UTC</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600">sohaibikram249@gmail.com</p>
